...
def parser():
	...
	parser_train.add_argument('--epochs', type=int, default=20)
	parser_train.add_argument('--hidden_channels', type=int, default=256)
	parser_train.add_argument('--num_flow_steps', type=int, default=2)
	parser_train.add_argument('--num_levels', type=int, default=2)
	parser_train.add_argument('--num_splits', type=int, default=2)
	parser_train.add_argument('--chunk_size', type=int, default=2)
